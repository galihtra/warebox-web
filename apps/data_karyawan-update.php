				  ...
				  <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
					  ...
					  <div class="form-group">
						...
						<select class="form-control" name="division">
							<option value="Laki-Laki" <?php if($division=="Laki-Laki") echo 'selected="selected"'; ?> >Laki-Laki</option>
							<option value="Perempuan" <?php if($division=="Perempuan") echo 'selected="selected"'; ?> >Perempuan</option>
						</select>
